...
class TestRequests(unittest.TestCase):
    def setUp(self):
        ...
        self.driver = webdriver.Chrome(service_log_path='/Users/chefe02/Desktop/presales_cert/Artifacts/2018-10-26_11-22-54.832368bz/webdriver.log', chrome_options=options)
    ...
    def test_requests(self):
        ...
        with apiritif.transaction_logged(u'go to home page'):
            self.driver.get(_tpl.apply(u'http://demo-caapm.bzm-presales.com/nopcommerce'))
        ...
        with apiritif.transaction_logged(u'add fahrenheit 451 to cart'):
            self.driver.find_element(By.CSS_SELECTOR, _tpl.apply(u'input.button-2.product-box-add-to-cart-button')).click()


        with apiritif.transaction_logged(u'click "accessories"'):
            self.driver.find_element(By.LINK_TEXT, _tpl.apply(u'Apparel')).click()
            self.driver.find_element(By.CSS_SELECTOR, _tpl.apply(u'img[alt="Picture for category Accessories"]')).click()
