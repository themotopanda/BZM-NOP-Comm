...
class TestRequests(unittest.TestCase):
    def setUp(self):
        ...
        self.driver = webdriver.Chrome(service_log_path='/Users/chefe02/Desktop/presales_cert/Artifacts/2018-10-26_11-23-27.114150bz/webdriver.log', chrome_options=options)
