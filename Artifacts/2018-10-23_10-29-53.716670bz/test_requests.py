...
class TestRequests(unittest.TestCase):
    def setUp(self):
        ...
        self.driver = webdriver.Chrome(service_log_path='/Users/chefe02/Desktop/presales_cert/Artifacts/2018-10-23_10-29-53.716670bz/webdriver.log', chrome_options=options)
